FLAGS = -Wall -ansi -pedantic -Isrc -Isrc/utils -Isrc/structures -Isrc/first-run -Isrc/first-pass -Isrc/first-pass/data -Isrc/first-pass/emit -Isrc/first-pass/output -Isrc/second-run -Isrc/error-handler -Isrc/code_conversion -Isrc/memory_map -Isrc/pre-assembler
